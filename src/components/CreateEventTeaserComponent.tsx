...
My name is Jeoffy Hipolito, I have 12 years’ experience in Web Development and more than 
...
I was browsing your website codeLingo.io and find the product very interesting and I want to be 
a part of the team to do all the duties and responsibilities required. I am currently working in 
SilverStripe as a Developer in bespoke team. However, I realised that I could do more in Software 
than building Websites, as I find Software as a Service (SaaS) products more exciting to get involve, 
fun and challenging to code.

In my previous job, I worked as a Web/Front-End Developer and mainly used ReactJS, Redux, TypeScript, 
NodeJS, etc. I also helped the UI/UX designer in planning as well as the organization's innovation activities 
and visited the farm/farmers for a product interview. I also have headless CMS experience using NextJs, 
KeystoneJS, GraphQL and MongoDB which gives me more confident that I am a great fit for this position. 

I sincerely hope that you will consider my application and discuss it further. 

Please see my attached resume for your reference. Thank you for your time 
